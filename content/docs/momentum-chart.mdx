...
description: Shows a metric’s momentum with an animated value, percentage change, and trend line.
---

import { MomentumChart } from "@/components/charts/momentum-chart.tsx";
...
<Step>
### Add the DotPattern background component

```tsx title="dot-pattern.tsx"
"use client";
